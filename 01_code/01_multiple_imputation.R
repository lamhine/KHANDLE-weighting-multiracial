...
# Purpose: Handle missing data in KHANDLE
# Original author: Taylor Mobley (adapted from Eleanor Hayes-Larson)
# Modified by: Tracy Lam-Hine
# Last updated: 2025-05-15
#------------------------------------------------------------------

source("config/config.R") #TLH added
...
p_load("tidyverse","survey", "tableone", "mice", "openxlsx")
...
load(file.path(processed_data_dir, "KHANDLE_clean.Rdata")) #TLH updated
...
save(khandle_analysis_pmm, file = file.path(processed_data_dir, "khandle_analysis_pmm.Rdata"))
